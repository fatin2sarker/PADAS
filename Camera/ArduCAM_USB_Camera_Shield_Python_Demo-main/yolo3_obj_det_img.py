...
#def detect(x):
#INPUT_FILE='data/1_stop_sign.jpg'
#INPUT_FILE='data/3_green.jpg'
#INPUT_FILE='data/1_red.jpg'
#INPUT_FILE='data/4_crosswalk.jpg'
INPUT_FILE='data/6_crosswalk.jpg'
#INPUT_FILE='data/5_crosswalk.jpg'
...
if len(idxs) > 0:
    ...
    for i in idxs.flatten():
        ...
        cv2.putText(image, text, (x, y - 5), cv2.FONT_HERSHEY_SIMPLEX,
            0.5, color, 2)
        if LABELS[classIDs[i]] == "person" and confidences[i] > 0.6:
            print("ALERT: Brake", LABELS[classIDs[i]], "in front of you!")
        if LABELS[classIDs[i]] == "car" and confidences[i] > 0.794:
            print("ALERT: Brake", LABELS[classIDs[i]], "in front of you!")
        if LABELS[classIDs[i]] == "traffic light" and confidences[i] > 0.7:
            print("CAUTION:", LABELS[classIDs[i]], "ahead!")
        if LABELS[classIDs[i]] == "stop sign":
            print("ALERT:", LABELS[classIDs[i]], "ahead!")
